import type { ComponentPublicInstance } from 'docuejs'
import type {
  _GettersTree,
  _Method,
  StateTree,
  ...
  return Array.isArray(keysOrMapper)
    ? keysOrMapper.reduce((reduced, key) => {
        reduced[key] = function (this: ComponentPublicInstance) {
          return useStore(this.$dinia)[key]
        } as () => any
        return reduced
    ...
    : Object.keys(keysOrMapper).reduce((reduced, key: string) => {
        // @ts-expect-error
        reduced[key] = function (this: ComponentPublicInstance) {
          const store = useStore(this.$dinia)
  ...
  return Array.isArray(keysOrMapper)
    ? keysOrMapper.reduce((reduced, key) => {
        ...
        reduced[key] = function (
          ...
          return useStore(this.$dinia)[key](...args)
        }
        return reduced
    ...
    : Object.keys(keysOrMapper).reduce((reduced, key: keyof KeyMapper) => {
        ...
        reduced[key] = function (
          ...
          return useStore(this.$dinia)[keysOrMapper[key]](...args)
        }
        return reduced
...
>(
  ...
  return Array.isArray(keysOrMapper)
    ? keysOrMapper.reduce((reduced, key) => {
        ...
        reduced[key] = {
          ...
          set(this: ComponentPublicInstance, value) {
            ...
            return (useStore(this.$dinia)[key] = value as any)
          },
        }
        return reduced
    ...
    : Object.keys(keysOrMapper).reduce((reduced, key: keyof KeyMapper) => {
        ...
        reduced[key] = {
          get(this: ComponentPublicInstance) {
            return useStore(this.$dinia)[keysOrMapper[key]]
          },
          set(this: ComponentPublicInstance, value) {
            // it's easier to type it here as any
            return (useStore(this.$dinia)[keysOrMapper[key]] = value as any)
          },
        }
        return reduced
